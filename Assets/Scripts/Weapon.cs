...
public class Weapon : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (boardButton == null)
        {
            GameObject buttonObject = GameObject.Find("Leaderboard");
            if (buttonObject != null)
            {
                boardButton = buttonObject.GetComponent<BoardButton>();
            }
        }
    ...
    private void Update()
    {
        ...
        scoreText.text = PhotonNetwork.LocalPlayer.GetScore().ToString() + "/ 1000";
    ...
    void Fire()
    {
        ...
        if (Physics.Raycast(ray.origin, ray.direction, out hit, 100f))
        {
            ...
            if (hit.transform.gameObject.TryGetComponent(out Health health) && boardButton.gameStart == true)
            {
